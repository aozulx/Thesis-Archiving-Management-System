...
<head>
    ...
    <title>URS Archive | Uploaded Theses</title>
...
<body>
   ...
   <div class="left-nav ">
    ...
    <div class="thesis-label">UPLOADED THESES</div>
                ...
                <div class="title-parent-container">
                        <div class="title-container">
                            ...
                            <div class="data-input-container">
                                <input type="text" class="data-input" id="title" name="title" placeholder="Title of the study" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="abstract-parent-container">
                        <div class="abstract-container">
                            ...
                            <div class="data-input-container">
                                <input type="text" class="data-input" id="abstract" name= "abstract" placeholder="Abstract" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="course-container">
                            ...
                            <div class="data-input-container">
                                <select name="select_course" id="select_course" class="data-input" disabled required>
                                        ...
                                        <option data-value="COE" value="Bachelor of Elementary Education">Bachelor of Elementary Education</option>
                                        <option data-value="COE" value="Bachelor of Secondary Education">Bachelor of Secondary Education</option>
                                        <option data-value="CHI" value="BS Hospitality Management">BS Hospitality Management</option>
