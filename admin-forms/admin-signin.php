...
<head>
    ...
    <title>URS Archive | Administrator</title>
</head>
                ...
                <div class="login-form-container">
                    ...
                    <div class="login-form">
                        <div class="login-input-container">
                            <input type="number" class="login-input-accountid" name="account_id" placeholder="Account ID" required>
                        </div>

                        <div class="login-input-container">
                            <input type="text" class="login-input-username" name="username" placeholder="Username" required>
                        </div>

                        <div class="login-input-container">
                            <input type="password" class="login-input-password" name="password" placeholder="Password" id="login-input-password" required>
                        </div>
